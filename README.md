...
8. **Chronomètre flottant** – disponible sur toutes les vues si activé, avec boutons Start/Pause/Reset/Rotation suivante et raccourci « Voir le classement ».
...
- Chronomètre sport : état visuel (running/finish), feedback son + vibration optionnels, bouton « rotation suivante » synchronisé avec la mise en évidence des cartes.
...
- **Mode live premium** : 4 zones (header Live, matchs/tuiles score, classement live, commandes). Scoreboard tactile avec boutons +/−, indication des équipes au repos, statut rotation, chrono synchronisé (start/pause/reset + rotation suivante), bouton Terminer, mode écran géant et tableau live Pos/Équipe/Pts/Diff/J.
...
- **Chronomètre** : widget flottant, boutons tactiles XL, état « running » coloré, message de fin et raccourci vers le classement.
